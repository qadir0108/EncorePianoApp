...
public class DynamicListView extends ListView {
    ...
    /**
     * Listens for long clicks on any units in the listview. When a cell has
     ...
     *  over the listview's units whenever the listview is redrawn.
     */
    @Override
...
//    }
     ...
     * upward or downward smooth scroll so as to reveal new units.
     */
    ...
    public interface SwappableListAdapter {
        /** swaps the units in the adapter, calling notifyDataSetChanged when finished */
