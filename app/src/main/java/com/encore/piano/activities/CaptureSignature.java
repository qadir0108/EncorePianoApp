...
public class CaptureSignature extends Activity implements ProgressUpdateListener { 
	...
	ActionBar actionBar;
	String tempDir;
	String path = "Androidpod/LoginSignatures";
...
//	}
	...
	private void onSaveOptionClick(){
		...
		Intent i = new Intent(CaptureSignature.this, com.encore.piano.activities.StartScreen.class);
		i.putExtra("myPath", myPath.getAbsolutePath());
